...
SRCS = main.c syntax/syntax_error.c syntax/utils.c syntax/check_quotes.c split_input.c pipe_split/ft_split_pipe.c pipe_split/utils.c sep_redirection.c expanding.c \
		export/export.c export/utils.c execute.c built_ins.c quotes_remover.c export/unset.c export/sortenv.c export/utils2.c \
		execution/open_redirections.c execution/execute_cmds.c signals_handler.c
OBJECTS = $(SRCS:%.c=%.o)
